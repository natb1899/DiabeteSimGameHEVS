...
class AsscHospital extends Perso with HasGameRef<DiabeteGameSceneNurseOffice> {
  AsscHospital(String user)
      : super(fileNamePngCharacter: GameImageAssets.asscHospital);
